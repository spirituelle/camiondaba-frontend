...
export default function Error404() {
  ...
  useEffect(() => {
    ...
    var boxCenter = [
      box.current.offsetLeft + box.current.innerWidth / 2,
      box.current.offsetTop + box.current.innerHeight/ 2
    ];
    ...
    return (
        <div style={{marginTop: "6rem", position: "relative"}}>
          <div className="message-404">
            ...
            <a href="https://brettthurston.com" className="button-404 btn-effect-404">
          ...
          <div className="compass-container-404">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 288 288">
            <title>compass_vector</title>
            <g id="Base">
              <line x1="51.25" y1="42.75" x2="243" y2="242" style={{fill: "none",stroke: "#000",strokeMiterlimit: 10,strokeWidth: "0.5px",strokeDasharray: 12.002400398254395}}/>
              <line x1="43.75" y1="239.75" x2="243.5" y2="47.5" style={{fill: "none",stroke: "#000",strokeMiterlimit: 10,strokeWidth: "0.5px",strokeDasharray: 12.002400398254395}}/>
              <line x1="142.33" y1="211.33" x2="144.92" y2="75.92" style={{fill: "none",stroke: "#000",strokeMiterlimit: 10,strokeWidth: "0.5px",strokeDasharray: 12.002400398254395}}/>
              <line x1="209.12" y1="144.88" x2="78.13" y2="142.37" style={{fill: "none",stroke: "#000",strokeMiterlimit: 10,strokeWidth: "0.5px",strokeDasharray: 12.002400398254395}}/>
              ...
              <circle cx="144" cy="144" r="74.5" style={{fill: "none",stroke: "#000",strokeMiterlimit: 10}}/>
            </g>
            <g id="Spinner" ref={box} style={{ transform: transform}}>
              <g>
                <g>
                ...
                <g>
                  <circle cx="144" cy="144" r="8" style={{fill: "#fff",stroke: "#000",strokeMiterlimit: 10}}/>
